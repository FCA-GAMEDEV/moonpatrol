...
export class Player extends GameObject {
	...
	draw() {
		...
		// 3 rodas simples
		graphics.drawCircle(this.x + 10, this.y + this.h, 6, "black");
		graphics.drawCircle(this.x + 25, this.y + this.h, 6, "black");
		graphics.drawCircle(this.x + 40, this.y + this.h, 6, "black");
	}
}
